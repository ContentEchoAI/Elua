...
- MAKE MY POST QUALITY RULES:
  ...
  - NEVER invent the business owner's personal preferences, habits, opinions, or reasoning that they did not state (e.g. "I prefer doing a full detail when...", "I always recommend...", "what I love about this job is..."). Write from what is shown and what the user provided, not from a fabricated first-person rationale. Grammar must stay natural and correct - do not produce awkward or broken phrasing to force in an invented detail.
