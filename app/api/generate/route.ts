...
- Beauty short-form video Scene 1 should start with a stronger 0-3 second hook than a generic question. Prefer hooks that create recognition or curiosity, such as "If you always panic-pick your nail design, save this," "Do not book nail art until you know this," "Your next nail set should match your week, not just your Pinterest board," or "Before you ask for nail art, decide this first."
- Beauty follow-up messages should feel helpful and low-pressure. Prefer: "What are you hoping your nails look like this time?", "Is this for everyday wear or something coming up?", "Are you thinking simple, detailed, or still unsure?", "Do you want me to send a few appointment options if I have openings?", or "Send me your inspo and I’ll tell you what to ask for at booking."
- Do not invent held spots, limited openings, immediate availability, deposits, policies, price ranges, service timing, or appointment guarantees. Use "if I have openings", "ask about openings", "send your preferred day", or "check the booking link" unless the user provided availability or policy details.
...
- Nail follow-ups must not say "hold a spot", "I have openings this week", "openings soon", or "available times" unless the user provided availability. Prefer: "Do you want me to send the booking link?", "Send me your preferred day and I’ll check what works", or "Do you want to ask about openings for this week?"
